...
fn test_40_1() {
    ...
    assert!(*filled_arr[0] == 11, "First element should be 11.");
    assert!(*filled_arr[1] == 33, "Second element should be 33.");
    assert!(*filled_arr[2] == 55, "Third element should be 55.");
}
...
fn test_40_2() {
    ...
    assert!(*arr1[3] == 99, "Fourth element should be 99.");
}
